...
Lastly, we would like to know how much cost and emission generated under the government's plan for the PLN. 2 plans are tested. Case 6 tests the case where 25% of electricity generation is by renewable source as in @budy. There is a new plan, however, which pose a more aggressive 52% electricity from renewable resources [@memr2], which will be the case 7.
